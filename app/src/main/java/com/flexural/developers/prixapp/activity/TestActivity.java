...
public class TestActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String pin, serialNumber;
        ...
        public void handlerIntent(Message msg)
        {
            switch (msg.what)
            {
                ...
                case MSG_IS_NORMAL:
                    ...
                    break;
                case MSG_IS_BUSY:
                    Toast.makeText(TestActivity.this, R.string.printer_is_working, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_PAPER_LESS:
                    loopPrintFlag = DEFAULT_LOOP_PRINT;
                    Toast.makeText(TestActivity.this, R.string.out_of_paper, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_PAPER_EXISTS:
                    Toast.makeText(TestActivity.this, R.string.exists_paper, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_THP_HIGH_TEMP:
                    Toast.makeText(TestActivity.this, R.string.printer_high_temp_alarm, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_MOTOR_HIGH_TEMP:
                    loopPrintFlag = DEFAULT_LOOP_PRINT;
                    Toast.makeText(TestActivity.this, R.string.motor_high_temp_alarm, Toast.LENGTH_SHORT).show();
                ...
                case MSG_CURRENT_TASK_PRINT_COMPLETE:
                    Toast.makeText(TestActivity.this, R.string.printer_current_task_print_complete, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] title1 = "Prix Airtime\n".getBytes("GBK");
                    byte[] title2 = "*130*7467*\n".getBytes("GBK"); //
                    byte[] fontTest0 = pin.getBytes("GBK");
                    byte[] fontTest1 = "#".getBytes("GBK");
                    byte[] fontTest2 = "\n\n".getBytes("GBK");
                    byte[] fontTest3 = "S/N: ".getBytes("GBK");
                    byte[] orderSerinum = serialNumber.getBytes("GBK");
                    byte[] testSign = "------------------------\n".getBytes("GBK");
                    byte[] testInfo = "Welcome to use bluetooth printer\n".getBytes("GBK");
                    ...
                    byte[][] cmdBytes = {printer_init,lineH0,fontSize3,align1,title1,fontSize1,title2,nextLine,align0,
                            fontSize0,fontSize0,fontTest0,lineH1,fontSize1,fontTest1,lineH0,fontSize2,fontTest2,
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "Left margin 0 point test\n".getBytes("GBK");
                    byte[] text1 = "8 points test on left margin\n".getBytes("GBK");
                    byte[] text2 = "16-point test on left margin\n".getBytes("GBK");
                    byte[] text3 = "24 point test on left margin\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "0 point left margin,320 dot width test of printing area\n".getBytes("GBK");
                    byte[] text1 = "24 points left margin,304 dot width test of printing area\n".getBytes("GBK");
                    byte[] text2 = "24 points left margin,Print area 256 dot wide test\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "Right spacing 0 point test\n".getBytes("GBK");
                    byte[] text1 = "Right spacing 8 points test\n".getBytes("GBK");
                    byte[] text2 = "Right spacing 24 points test\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] align2 = ESCUtil.alignMode((byte)2);
                    byte[] leftMargin0 = ESCUtil.printLeftMargin(0);
                    byte[] text0 = "Left alignment test\n".getBytes("GBK");
                    byte[] text1 = "Centering test\n".getBytes("GBK");
                    byte[] text2 = "Right alignment test\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "c".getBytes("GBK");
                    byte[] text1 = "Right spacing 0 points".getBytes("GBK");
                    byte[] text2 = "Right spacing 0 points".getBytes("GBK");
                    byte[] text3 = "Relative position 48 point test".getBytes("GBK");
                    byte[] text4 = "8 points on the right".getBytes("GBK");
                    byte[] text5 = "Relative position 48 test".getBytes("GBK");
                    byte[] text6 = "24 points on the right".getBytes("GBK");
                    byte[] text7 = "Relative position 96 test".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "Absolute printing position 0 o'clock test\n".getBytes("GBK");
                    byte[] text1 = "Absolute printing position 96 points test\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] text0 = "Tab".getBytes("GBK");
                    byte[] text1 = "4 ascii characters\n".getBytes("GBK");
                    byte[] text2 = "6 ascii characters\n".getBytes("GBK");
                    byte[] text3 = "10 ascii characters\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] relative2 = ESCUtil.relativePrintPosition(48);
                    byte[] text0 = "Underscore".getBytes("GBK");
                    byte[] text1 = "ABC".getBytes("GBK");
                    byte[] text2 = "123".getBytes("GBK");
                    byte[] text3 = "Underscore".getBytes("GBK");
                    byte[] text4 = "test".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] align1 = ESCUtil.alignMode((byte)1);
                    byte[] align2 = ESCUtil.alignMode((byte)2);
                    byte[] text0 = "   #4 word of mouth takeaway\n".getBytes("GBK");
                    byte[] text1 = "         Feng Ji Yellow Braised Chicken Rice\n".getBytes("GBK");
                    byte[] text2 = "17:20 Delivered as soon as possible\n".getBytes("GBK");
                    byte[] text3 = "--------------------------------\n".getBytes("GBK");
                    byte[] text4 = "18610858337 Wei Xiaobao Chuangzhi Tiandi Plaza Building 7(Room 605)".getBytes("GBK");
                    byte[] text5 = "Place an order: 16:35\n".getBytes("GBK");
                    byte[] text6 = "********************************\n".getBytes("GBK");
                    byte[] text7 = "Dishes          quantity   unit price   Amount\n".getBytes("GBK");
                    byte[] text8 = "Braised Pork Belly (Big) (not spicy)\n".getBytes("GBK");
                    byte[] text9 = "               1      25      25\n".getBytes("GBK");
                    byte[] text10 = "Braised Pork Belly (small) (not spicy)\n".getBytes("GBK");
                    byte[] text11 = "Braised Pork Belly (small) (Slightly spicy\n)\n".getBytes("GBK");
                    byte[] text12 = "Delivery fee                         2\n".getBytes("GBK");
                    byte[] text13 = "            The amount actually paid: 27\n\n".getBytes("GBK");
                    byte[] text14 = "    Word of mouth takeaway\n\n\n".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] align0 = ESCUtil.alignMode((byte)0);
                    byte[] align1 = ESCUtil.alignMode((byte)1);
                    String Baidu = "Keep in this shop\n************************\n      Baidu Waimai\n\n      [Cash on delivery\n]\n" +
                            "************************\nExpected delivery time：Ship now\n" +
                            "order notes:Deliver to Ximen,Don't be spicy\nInvoice Information:Baidu Waimai\n************************\nOrder number: 14187186911689\norder time: " +
                            "2014-12-16 16:31************************\n" +
                            "Dish name     quantity  Amount\n------------------------\n" +
                            "Spicy Noodle Set     1   40.00\nVegan Antenna Burger   1   38.00\nSpicy Noodle Set     1   40.00\n" +
                            "Vegan Antenna Burger   1   38.00\nSpicy noodles         1   43.00\n" +
                            "Vegetarian antenna       1   34.00\n" +
                            "------------------------\n" +
                            "************************\nName:Baidu test\n\n" +
                            "address:Tairan Industry and Trade Park\ntelephone:18665248965\n" +
                            "************************\nBaidu test merchant\n\n" +
                            "18665248965\n#15 Baidu Waimai\n November 09 \n\n\n";
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] align1 = ESCUtil.alignMode((byte)1);
                    byte[] align2 = ESCUtil.alignMode((byte)2);
                    byte[] text0 = "  #1  Meituan Test\n\n".getBytes("GBK");
                    byte[] text1 = "      Cantonese-Hong Kong Style Roast Meat(Section 1)\n\n".getBytes("GBK");
                    byte[] text2 = "------------------------\n\n*********Order Form*********\n".getBytes("GBK");
                    byte[] text3 = "--------------------------------\n".getBytes("GBK");
                    byte[] text4 = "  Expected delivery time:[18:00]\n\n".getBytes("GBK");
                    byte[] text5 = "Remark: Don't be too spicy\n".getBytes("GBK");
                    byte[] text6 = "Dishes          quantity   Subtotal amount\n".getBytes("GBK");
                    byte[] text7 = "Braised pork          X1    12\nBraised Pork 1         X1    12\nBraised Pork 2         X1    12\n".getBytes("GBK");
                    byte[] text8 = "Delivery fee                         5\n".getBytes("GBK");
                    byte[] text9 = "Lunch box fee                         1\n".getBytes("GBK");
                    byte[] text10 = "[Overtime payment] - See order for details\n".getBytes("GBK");
                    byte[] text11 = "Coca Cola: x1\n".getBytes("GBK");
                    byte[] text12 = "total                18 yuan\n".getBytes("GBK");
                    byte[] text13 = "open* 18312345678\nAddress information\n".getBytes("GBK");
                    byte[] text14 = "  #1  Meituan Test\n\n\n".getBytes("GBK");
                    byte[] text15 = "order time: 01-01 12:00".getBytes("GBK");
                    byte[] nextLine = ESCUtil.nextLines(1);
                    byte[] performPrint = ESCUtil.performPrintAndFeedPaper((byte)160);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    byte[] align0 = ESCUtil.alignMode((byte)0);
                    byte[] align1 = ESCUtil.alignMode((byte)1);
                    String Elemo = "****#1Hungry takeaway order****\n        卡萨披萨       \n       --已支付--      \n" +
                            "      预计19:00送达     \n[时间]:2014-12-03 16:21\n  不吃辣 辣一点 多加米\n " +
                            "[发票]这是一个发票抬头\n------------------------\n菜名          数量  " +
                            "小计\n--------1号篮子---------\n测试美食一        X4   4\n" +
                            "测试美食二        X6   6\n测试美食三        X2   2\n" +
